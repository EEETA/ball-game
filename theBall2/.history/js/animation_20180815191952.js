...
//             if(launchBallColor=='rgb(239, 169, 122)' && numbox%360==rou){  //肉
//                 success(r,num);
//             }else if(launchBallColor=='rgb(244, 86, 70)' && numbox%360==red){  //红
//                 success(r,num);
//             }else if(launchBallColor=='rgb(109, 211, 206)' && numbox%360==qing){  //青
//                 success(r,num);
//             }else if(launchBallColor=='rgb(51, 51, 51)' && numbox%360==black){  //黑
//                 success(r,num);
//             }
//             else{fail(r)};
//     }
...
function movejudge(r,direction,num,patternNow){
    ...
    */
    ...
    if(launchBallColor=='rgb(239, 169, 122)' && numList%360==rou){  //肉
        success(r,num);
    }else if(launchBallColor=='rgb(244, 86, 70)' && Math.abs(numList%360)==180){  //红
        success(r,num);
    }else if(launchBallColor=='rgb(109, 211, 206)' && numList%360==qing){  //青
        success(r,num);
    }else if(launchBallColor=='rgb(51, 51, 51)' && Math.abs(numList%360)==0){  //黑
        success(r,num);
    }
    else{fail(r)};
