...
function movejudge(r,direction,num,patternNow){
    ...
    launchBallColor=$(r).css('background-color');
    console.log(launchBallColor);
    console.log(numList);

    if(launchBallColor=='rgb(244, 86, 70)' && Math.abs(numList%360)==0 && balo==-1){  //红
        success(r,num);
    }
    else if(launchBallColor=='rgb(51, 51, 51)' && Math.abs(numList%360)==180 && balo==1){  //黑
        success(r,num);
    }
    else{fail(r)};
