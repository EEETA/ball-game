...
function movejudge(r,direction,num,patternNow){
    ...
    */
    ...
    if(direction=='shang'){
        if(shootBallColor=='rgb(51, 51, 51)'&&balo==1){
            success(r,num,shootBallColor);
        }else if(shootBallColor=='rgb(244, 86, 70)'&&balo==-1){
            success(r,num,shootBallColor);
        }else{fail(r)};
    }else if(direction=='xia'){
        if(shootBallColor=='rgb(244, 86, 70)'&&balo==1){
            success(r,num,shootBallColor);
        }
        else if(shootBallColor=='rgb(51, 51, 51)'&&balo==-1){
            success(r,num,shootBallColor);
        }else{fail(r)};
    }

    // if(shootBallColor=='rgb(51, 51, 51)'){  //黑
    //     console.log('判定为黑色');
    //     success(r,num,shootBallColor);
