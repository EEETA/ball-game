...
//     //     numbox=negative;
//     // }
//     if($(r).css('background-color')=='rgb(239, 169, 122)' && Math.abs(numbox%360)==rou){  //肉
//         success(r,num);
//     }else if($(r).css('background-color')=='rgb(244, 86, 70)' && Math.abs(numbox%360)==red){  //红
//         success(r,num);
//     }else if($(r).css('background-color')=='rgb(109, 211, 206)' && Math.abs(numbox%360)==qing){  //青
//         success(r,num);
//     }else if($(r).css('background-color')=='rgb(51, 51, 51)' && Math.abs(numbox%360)==black){  //黑
//         success(r,num);
//     }
//     else{fail(r)};
    ...
    */
    ...
    if(patternNow==0){
        ...
        if(direction=='shang'){
            ...
            if(launchBallColor=='rgb(239, 169, 122)'&&Math.abs(numList%360)==egg){/*肉色*/
                success(r,4,launchBallColor);
            }else if(launchBallColor=='rgb(109, 211, 206)'&&Math.abs(numList%360)==green){/*青色*/
                success(r,4,launchBallColor);
            }else if(launchBallColor=='rgb(51, 51, 51)'&&Math.abs(numList%360)==black){/*黑色*/
                success(r,4,launchBallColor);
            }else if(launchBallColor=='rgb(244, 86, 70)'&&Math.abs(numList%360)==red){/*红色*/
                success(r,4,launchBallColor);
            }else{fail(r)};
