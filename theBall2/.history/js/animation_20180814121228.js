...
function movejudge(r,rou,red,qing,black,num,numberMode){
    numbox=numList;
    if(numList>0){
        numbox=negative;
    }
    ...
    */
    ...
    console.log($(r).css('background-color'));
    if($(r).css('background-color')=='rgb(244, 86, 70)'){  //红
        console.log('判定为红色');
        success(r,num);
    }else if($(r).css('background-color')=='rgb(51, 51, 51)'){  //黑
        console.log('判定为黑色');
        success(r,num);
    }
    else{fail(r)};
...
/*撞击成功*/
function success(r,borderSpacing){
    // switch_1=1;
