    ...
    launchBall.animate(
        {[direction]:""+range+"px"},
        {
            ...
            progress:function(){
                ...
                var launchBallW=$(this).width();
                var launchBallH=$(this).height();
                var launchBallT=$(this).offset().top;
                var launchBallL=$(this).offset().left;
                ...
                if(launchNum == 2){ //两个方向
                    if(range==350&&Math.floor(launchBallT+launchBallH)>=box_top){
                        movejudge(this,'shang',4,patternNow,balo);
                    }else if(range==-350&&launchBallT<=box_height){  //向上
                        movejudge(this,'xia',4,patternNow,balo);
                    }
                }
                // if(launchNum == 2){ //两个方向
                //     if(range==350&&this_height>=box_top){  //向下
                //         movejudge(this,-270,-0,-90,-180,4,patternNow);
                //     }else if(range==-350&&this_height<=box_height+100){  //向上
                ...
                // if(launchNum == 2){ //两个方向
                //     if(range==350&&this_height>=box_top){  //向下
                //         // if(this_height>=box_top){
                //             movejudge(this,-270,-0,-90,-180,4,patternNow);
                //         // }
                //     }else if(range==-350&&this_height<=box_height+100){  //向上
                //         // if(this_height<=box_height+100){
                //             movejudge(this,-90,-180,-270,-0,4,patternNow);
                //         // }
                //     }
                // }
